...
[2] Mohmal-Temp-Mail''')
    ...
    for i in range(accs):
        ...
        driver.find_element_by_name('email').send_keys(Keys.COMMAND, 'v')
        time.sleep(1)
        ...
        token = driver.execute_script('location.reload();var i=document.createElement("iframe");document.body.appendChild(i);return i.contentWindow.localStorage.token')
